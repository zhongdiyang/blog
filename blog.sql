...
CREATE TABLE user (
 ...
 group_id mediumint(8) NOT NULL default 1 COMMENT '用户组ID',
 user_name varchar(32) NOT NULL COMMENT '用户名',
 user_pwd varchar(32) NOT NULL COMMENT '用户密码',
 user_phone varchar(20) NULL COMMENT '用户手机号码',
 user_sex varchar(6) NULL COMMENT '用户性别',
 user_qq varchar(12) NULL COMMENT '用户QQ号码',
 user_email varchar(64) NULL COMMENT '用户EMAIL地址',
 user_address varchar(255) NULL COMMENT '用户地址',
 user_mark mediumint(9) NOT NULL default 0 COMMENT '用户积分',
 user_rank_id tinyint(3) NOT NULL default 1 COMMENT '用户等级',
 user_last_login_ip varchar(15) NOT NULL COMMENT '用户上一次登录IP地址',

 user_birthday DATE NULL COMMENT '用户生日',
 user_description varchar(255) NULL COMMENT '自我描述',
 user_image_url varchar(255) NULL COMMENT '用户头像存储路径',
 user_school varchar(255) NULL COMMENT '毕业学校',
 user_register_time timestamp COMMENT '用户注册时间',
 user_register_ip varchar(15) NOT NULL COMMENT '用户注册时IP地址',
 user_last_update_time datetime NULL COMMENT '用户上次更新博客时间',
 user_weibo varchar(255) NULL COMMENT '用户微博',
 user_blood_type char(3) NULL COMMENT '用户血型',
 user_says varchar(255) NULL COMMENT '用户语录',
 ...
 user_power varchar(255) NOT NULL default '普通' COMMENT '拥有权限',
 PRIMARY KEY (user_id)
...
CREATE TABLE article (
 ...
 article_time timestamp NOT NULL COMMENT '发布时间',
 ...
 article_img varchar(255) NOT NULL COMMENT '文章图片',
 article_show tinyint(3) NOT NULL DEFAULT 0 COMMENT '是否发布:0为否，1为是',
 article_support tinyint(3) NOT NULL DEFAULT 0 COMMENT '是否博主推荐:0为否，1为是',
 PRIMARY KEY (article_id)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ;

 
-- 1	1	zdy	123123						0	1	127.0.0.1					127.0.0.1					0	0	1	2018-06-21 10:12:15	2018-06-21 10:12:30	
